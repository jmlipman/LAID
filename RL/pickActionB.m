% PICKACTIONB.m - Pick actions given the current state.
% 
% This function will return an action decided to be taken. It may not
% choose the best one since it is an e-greedy algorithm.
%
...
function [ selectedAction ] = pickActionB( currentState, hMdt, hMlr, Q, eps )
